...
{
      17,     0,    -1,    -1,    19,    18,    -1,    29,    -1,    20,
      -1,    -1,    13,    -1,    13,    -1,     6,     4,    -1,    -1,
       7,    14,    -1,     7,    15,    -1,    -1,     8,    -1,    -1,
       9,    -1,    -1,    10,     4,    -1,    -1,    11,     4,    -1,
      -1,    22,    23,    24,    25,    26,    27,    -1,     5,    12,
      21,    28,    -1
};
...
{
  "$end", "error", "$undefined", "STRING", "NUMBER", "EVALUATION", "PLIES", 
  "CUBE", "CUBEFUL", "CUBELESS", "NOISE", "REDUCED", "FIBSBOARD", 
  "AFIBSBOARD", "ON", "OFF", "$accept", "the_command", "command", 
  "reset_command", "cmdfibsboard", "fibsboard", "optplies", "optcube", 
  "optcubeful", "optcubeless", "optnoise", "optreduced", "evalcontext", 
  "evaluation", 0
};
#endif
...
{
       6,     0,     0,     1,     0,     7,     3,     5,     4,     0,
       8,    10,     0,    13,    23,     9,     0,    15,    11,    12,
      14,    17,    16,    19,     0,    21,    18,     0,    22,    20
};
...
{
       3,     4,    -5,   -14,    -7,   -14,   -14,   -14,   -14,    -6,
     -14,     0,     5,     6,   -14,   -14,   -13,     2,   -14,   -14,
     -14,     7,   -14,     1,     8,     9,   -14,    10,   -14,   -14
};
...
{
       4,    18,    19,    -2,     3,     9,    12,    10,     5,    15,
      20,    24,    26,    16,    29,     0,    22,     0,     0,     0,
      27
};

static const yysigned_char yycheck[] =
{
       5,    14,    15,     0,     0,    12,     6,    13,    13,     4,
       8,    10,     4,     7,     4,    -1,     9,    -1,    -1,    -1,
      11
};
...
{
       0,    17,    19,     0,     5,    13,    18,    20,    29,    12,
      13,    21,     6,    22,    28,     4,     7,    23,    14,    15,
       8,    24,     9,    25,    10,    26,     4,    11,    27,     4
};
...
#line 96 "external_y.y"
  ...
  case 16:
#line 100 "external_y.y"
    { ec.fCubeful = FALSE; ;}
    break;

  case 18:
#line 104 "external_y.y"
