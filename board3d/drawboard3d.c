...
if (bd->roundedEdges)
{
	...
	glBegin(GL_QUADS);
		/* Front Face */
		glNormal3f(0, 0, 1);
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		...
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, TOTAL_HEIGHT / 2.0f, BASE_DEPTH + EDGE_DEPTH);

		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, TOTAL_HEIGHT / 2.0f, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(TOTAL_WIDTH - BOARD_FILLET, TOTAL_HEIGHT / 2.0f, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(TOTAL_WIDTH - BOARD_FILLET, TOTAL_HEIGHT - BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, TOTAL_HEIGHT - BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		/* Right face */
		glNormal3f(1, 0, 0);
		...
		/* Left Face */
		glNormal3f(-1, 0, 0);
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, BOARD_FILLET, 0);
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, TOTAL_HEIGHT - BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(TOTAL_WIDTH - EDGE_WIDTH, TOTAL_HEIGHT - BOARD_FILLET, 0);
	glEnd();
	...
	if (!bd->showHinges)
	{
		glBegin(GL_QUADS);
			/* Front Face */
			glNormal3f(0, 0, 1);
			glVertex3f(EDGE_WIDTH, BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(TOTAL_WIDTH / 2.0f, BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(TOTAL_WIDTH / 2.0f, EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(EDGE_WIDTH, EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			...
			/* Top Face */
			glNormal3f(0, 1, 0);
			glVertex3f(BOARD_FILLET, EDGE_HEIGHT, 0);
			glVertex3f(BOARD_FILLET, EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(TOTAL_WIDTH - BOARD_FILLET, EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(TOTAL_WIDTH - BOARD_FILLET, EDGE_HEIGHT, 0);
			/* Bottom Face */
			glNormal3f(0, -1, 0);
		...
		glBegin(GL_QUADS);
			...
			glNormal3f(0, 0, 1);
			glVertex3f(EDGE_WIDTH, TOTAL_HEIGHT - EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(TOTAL_WIDTH / 2.0f, TOTAL_HEIGHT - EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(TOTAL_WIDTH / 2.0f, TOTAL_HEIGHT - BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(EDGE_WIDTH, TOTAL_HEIGHT - BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
			...
			/* Bottom Face */
			glNormal3f(0, -1, 0);
			glVertex3f(BOARD_FILLET, TOTAL_HEIGHT - EDGE_HEIGHT, 0);
			glVertex3f(TOTAL_WIDTH - BOARD_FILLET, TOTAL_HEIGHT - EDGE_HEIGHT, 0);
			glVertex3f(TOTAL_WIDTH - BOARD_FILLET, TOTAL_HEIGHT - EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
			glVertex3f(BOARD_FILLET, TOTAL_HEIGHT - EDGE_HEIGHT, BASE_DEPTH + EDGE_DEPTH);
		glEnd();
	}
	else
	{
...
if (bd->roundedEdges)
{
	...
	glBegin(GL_QUADS);
		...
		glVertex3f(EDGE_WIDTH, BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(EDGE_WIDTH, TOTAL_HEIGHT / 2.0f, BASE_DEPTH + EDGE_DEPTH);
		...
		/* Right face */
		glNormal3f(1, 0, 0);
		glVertex3f(EDGE_WIDTH, BOARD_FILLET, 0);
		glVertex3f(EDGE_WIDTH, TOTAL_HEIGHT - BOARD_FILLET, 0);
		glVertex3f(EDGE_WIDTH, TOTAL_HEIGHT - BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		glVertex3f(EDGE_WIDTH, BOARD_FILLET, BASE_DEPTH + EDGE_DEPTH);
		/* Left Face */
		glNormal3f(-1, 0, 0);
