...
static const GtkStockItem gnubg_stock_items[] = {
	...
	{GNUBG_STOCK_QUICK_GAME, N_("_Quick Game"), 0, 0, NULL},
...
static const struct {
	...
	GNUBG_STOCK_QUICK_GAME, runit_16, NULL, GTK_ICON_SIZE_MENU}, {
	GNUBG_STOCK_QUICK_GAME, runit_24, NULL, GTK_ICON_SIZE_LARGE_TOOLBAR}
};
