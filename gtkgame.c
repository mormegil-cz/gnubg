...
GtkItemFactoryEntry aife[] = {
	...
	{ N_("/G_o/Previous cmarked move"), NULL, Command, CMD_PREV_CMARKED, "<StockItem>", GNUBG_STOCK_GO_PREV_CMARKED },
	...
	{ N_("/G_o/Next cmarked move"), NULL, Command, CMD_NEXT_CMARKED, "<StockItem>", GNUBG_STOCK_GO_NEXT_CMARKED },
	{ N_("/G_o/Next marked move"), NULL, Command, CMD_NEXT_MARKED, "<StockItem>", GNUBG_STOCK_GO_NEXT_MARKED },
