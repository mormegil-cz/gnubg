...
movefilter aaamfMoveFilterSettings[ NUM_MOVEFILTER_SETTINGS ][ MAX_FILTER_PLIES ][ MAX_FILTER_PLIES ] = {
  /* tiny */
  { { { 3, 2, 0.03 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } ,
    { { 3, 2, 0.03 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } , 
    { { 3, 2, 0.03 }, { 0, 0, 0 }, { 2, 0, 0 }, { 0, 0, 0 } }, 
    { { 3, 2, 0.03 }, { 0, 0, 0 }, { 2, 0, 0 }, { 0, 0, 0 } } },
  /* narrow */
  { { { 5, 3, 0.05 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } ,
    { { 5, 3, 0.05 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } , 
    { { 5, 3, 0.05 }, { 0, 0, 0 }, { 2, 1, 0.03 }, { 0, 0, 0 } }, 
    { { 5, 3, 0.05 }, { 0, 0, 0 }, { 2, 1, 0.03 }, { 0, 0, 0 } } },
  /* normal */
  { { { 7, 4, 0.07 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } ,
    { { 7, 4, 0.07 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } , 
    { { 7, 4, 0.07 }, { 0, 0, 0 }, { 2, 2, 0.04 }, { 0, 0, 0 } }, 
    { { 7, 4, 0.07 }, { 0, 0, 0 }, { 2, 2, 0.04 }, { 0, 0, 0 } } },
  /* large */
  { { { 9, 5, 0.10 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } ,
    { { 9, 5, 0.10 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } , 
    { { 9, 5, 0.10 }, { 0, 0, 0 }, { 2, 3, 0.05 }, { 0, 0, 0 } }, 
    { { 9, 5, 0.10 }, { 0, 0, 0 }, { 2, 3, 0.05 }, { 0, 0, 0.0 } } },
  /* huge */
  { { { 11, 6, 0.2 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } ,
    { { 11, 6, 0.2 }, { 0, 0, 0 }, { 0, 0, 0 }, { 0, 0, 0 } } , 
    { { 11, 6, 0.2 }, { 0, 0, 0 }, { 2, 4, 0.1 }, { 0, 0, 0 } }, 
    { { 11, 6, 0.2 }, { 0, 0, 0 }, { 2, 4, 0.1 }, { 0, 0, 0.0 } } }
};
